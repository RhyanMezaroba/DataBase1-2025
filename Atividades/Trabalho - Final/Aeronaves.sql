...
INSERT INTO CLIENTE (NOME, CPF, IDADE, SEXO) VALUES
('João Silva', '11122233344', 35, 'MASCULINO'),
('Maria Souza', '22233344455', 28, 'FEMININO'),
('Pedro Lima', '33344455566', 42, 'MASCULINO'),
('Ana Costa', '44455566677', 19, 'FEMININO'),
('Carlos Pereira', '55566677788', 50, 'MASCULINO');

INSERT INTO CLIENTE_PREFERENCIAL (ID_CLIENTE, EMAIL, TELEFONE, ENDERECO) VALUES
(1, 'joao.silva@email.com', '11987654321', 'Rua Alfa, 123 - São Paulo/SP'),
(2, 'maria.souza@email.com', '21998877665', 'Av. Beta, 45 - Rio de Janeiro/RJ');
